<?php
   ...
   if(isset($_GET['id'])) {
    ...
    <div class="main-content">
        ...
        <form id="patient-details" style="padding:20px;">
            ...
            <fieldset class="col-md-8" style="margin: auto;">
                ...
                <div class="border bg-light py-3 px-lg-4" style="border-radius:10px; margin-bottom:10px;">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" readonly class="form-control" required value="<?php echo $First_Name ; ?>" name="First_Name">
                    </div>

                    <div class="input-group">
                        <span class="input-group-text">Last Name</span>
                        <input type="text" readonly class="form-control" required value="<?php echo $Last_Name ; ?>" name="Last_Name">
                    </div>

                    <div class="input-group">
                        <span class="input-group-text">Phone number</span>
                        <input type="text" readonly class="form-control" required value="<?php echo $Phone_number ; ?>" name="Phone_number">
                    </div>

                    <div class="input-group">
                        <span for="date-input" class="input-group-text">Date of Birth </span>
                        <input class="form-control" readonly type="date" value="<?php echo $BirthDate ; ?>" name="BirthDate">
                    </div>

                    <div class="input-group">
                        <span class="input-group-text">Address</span>
                        <input type="text" readonly class="form-control" required value="<?php echo $Address ; ?>" name="Address">
                    </div>
                    <div class="input-group">
                        <select class="custom-select" disabled name="DoctorId" required>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" readonly class="form-control" required value="<?php echo $EmailID ; ?>" name="EmailID">
                    </div>

                    <div class="input-group">
                        <span class="input-group-text">Social Security number</span>
                        <input type="text" readonly class="form-control" required value="<?php echo $Social_Security ; ?>" name="Social_Security">
                    </div>

                    <div class="input-group">
                        <span class="input-group-text">Gender</span>
                        <select class="custom-select" disabled  name="Gender" required>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" readonly class="form-control" required value="<?php echo $Height ; ?>" name="Height">
                    </div>

                    <div class="input-group">
                        <span class="input-group-text">Weight</span>
                        <input type="text" readonly class="form-control" required value="<?php echo $Weight ; ?>" name="Weight">
                    </div>

                    <div class="input-group">
                        <span class="input-group-text">Marital Status</span>
                        <select class="custom-select" disabled  name="Marital_Status" required>
                    ...
                    <div class="input-group">
                        ...
                        <select class="custom-select" disabled  name="Occupation" required>
                ...
                <div class="border bg-light py-3 px-lg-4" style="border-radius:10px; margin-bottom:10px;">
                    ...
                    <div class="input-group">
                        ...
                        <select class="custom-select" disabled  name="Cholesterol" required>
                    ...
                    <div class="input-group">
                        ...
                        <select class="custom-select" disabled  name="BloodPressure" required>
                    ...
                    <div class="input-group">
                        ...
                        <select class="custom-select" disabled  name="HeartDisease" required>
                    ...
                    <div class="input-group">
                        ...
                        <select class="custom-select" disabled  name="HepatitisB" required>
                    ...
                    <div class="input-group">
                        ...
                        <select class="custom-select" disabled  name="ChickenPox" required>
                    ...
                    <div class="input-group">
                        ...
                        <select class="custom-select" disabled  name="Measles" required>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" readonly class="form-control" required value="<?php echo $Medical_History ; ?>" name="Medical_History">
                    </div>

                    <div class="input-group">
                        <span class="input-group-text">Vaccination History</span>
                        <input type="text" readonly class="form-control" required value="<?php echo $Vaccination_History ; ?>" name="Vaccination_History">
                    </div>

                    <div class="input-group">
                        <span class="input-group-text">Other Health Issues</span>
                        <input type="text" readonly class="form-control" required value="<?php echo $OtherHealthIssues ; ?>" name="OtherHealthIssues">
                    </div>
