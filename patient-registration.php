  ...
  <div role="main" class="form-all">
      <ul class="form-section page-section">
              ...
              <div id="cid_5" class="form-input">
                  <div data-wrapper-react="true">
                      <span class="form-sub-label-container" style="vertical-align:top">
                          <input type="text" id="first_5" name="q5_name[first]" class="form-textbox" size="10" value="" data-component="first" aria-labelledby="label_5 sublabel_5_first" />
                          <label class="form-sub-label" for="first_5" id="sublabel_5_first" style="min-height:13px"> First Name </label>
                      </span>
                      <span class="form-sub-label-container" style="vertical-align:top">
                          <input type="text" id="last_5" name="q5_name[last]" class="form-textbox" size="15" value="" data-component="last" aria-labelledby="label_5 sublabel_5_last" />
          ...
          <li class="form-line" data-type="control_birthdate" id="id_7">
              ...
              <div id="cid_7" class="form-input">
                  <div data-wrapper-react="true">
                      <span class="form-sub-label-container" style="vertical-align:top">
                          <select name="q7_birthDate7[month]" id="input_7_month" class="form-dropdown" data-component="birthdate-month">
                              <option>  </option>
              ...
              <div id="cid_20" class="form-input">
                  <div class="form-single-column" role="group" aria-labelledby="label_20" data-component="radio">
                      <span class="form-radio-item" style="clear:left">
                          ...
                          <input type="radio" class="form-radio" id="input_20_0" name="q20_measles" value="Male" />
                          <label id="label_input_20_0" for="input_20_0"> Male </label>
                      </span>
                      <span class="form-radio-item" style="clear:left">
                          <span class="dragger-item">
                          </span>
                          <input type="radio" class="form-radio" id="input_20_1" name="q20_measles" value="Female" />
              ...
              <div id="cid_20" class="form-input">
                  <div class="form-single-column" role="group" aria-labelledby="label_20" data-component="radio">
                      <span class="form-radio-item" style="clear:left">
                          ...
                          <input type="radio" class="form-radio" id="input_20_0" name="q20_measles" value="Employed" />
                          <label id="label_input_20_0" for="input_20_0"> Employed </label>
                      </span>
                      <span class="form-radio-item" style="clear:left">
                          <span class="dragger-item">
                          </span>
                          <input type="radio" class="form-radio" id="input_20_1" name="q20_measles" value="Unemployed" />
                          <label id="label_input_20_1" for="input_20_1"> Unemployed </label>
                      </span>
                      <span class="form-radio-item" style="clear:left">
                          <span class="dragger-item">
                          </span>
                          <input type="radio" class="form-radio" id="input_20_1" name="q20_measles" value="Retied" />
              ...
              <div id="cid_20" class="form-input">
                  <div class="form-single-column" role="group" aria-labelledby="label_20" data-component="radio">
                      <span class="form-radio-item" style="clear:left">
                          ...
                          <input type="radio" class="form-radio" id="input_20_0" name="q20_measles" value="Single" />
                          <label id="label_input_20_0" for="input_20_0"> Single </label>
                      </span>
                      <span class="form-radio-item" style="clear:left">
                          <span class="dragger-item">
                          </span>
                          <input type="radio" class="form-radio" id="input_20_1" name="q20_measles" value="Married" />
                          <label id="label_input_20_1" for="input_20_1"> Married </label>
                      </span>
                      <span class="form-radio-item" style="clear:left">
                          <span class="dragger-item">
                          </span>
                          <input type="radio" class="form-radio" id="input_20_1" name="q20_measles" value="Divorced" />
                          <label id="label_input_20_1" for="input_20_1"> Divorced </label>
                      </span>
                      <span class="form-radio-item" style="clear:left">
                          <span class="dragger-item">
                          </span>
                          <input type="radio" class="form-radio" id="input_20_1" name="q20_measles" value="Widowed" />
                          <label id="label_input_20_1" for="input_20_1"> Widowed </label>
                      </span>
                      <span class="form-radio-item" style="clear:left">
                          <span class="dragger-item">
                          </span>
                          <input type="radio" class="form-radio" id="input_20_1" name="q20_measles" value="Other" />
    ...
    <li class="form-line" data-type="control_fullname" id="id_5">
        ...
        <div id="cid_5" class="form-input">
            <div data-wrapper-react="true">
                <span class="form-sub-label-container" style="vertical-align:top">
                    <input type="text" id="first_5" name="q5_name[first]" class="form-textbox" size="25" value="" data-component="first" aria-labelledby="label_5 sublabel_5_first" />
    ...
    <li class="form-line" data-type="control_fullname" id="id_5">
        ...
        <div id="cid_5" class="form-input">
                  ...
                  <table summary="" class="form-address-table">
                      <tbody>
                          <tr>
                              <td colspan="2">
                                  <span class="form-sub-label-container" style="vertical-align:top">
                                      <input type="text" id="input_8_addr_line1" name="q8_address8[addr_line1]" class="form-textbox form-address-line" autocomplete="address-line1" value="" data-component="address_line_1" aria-labelledby="label_8 sublabel_8_addr_line1" />
          ...
          <li class="form-line" data-type="control_fullname" id="id_12">
              ...
              <div id="cid_12" class="form-input">
                  <div data-wrapper-react="true">
                      <span class="form-sub-label-container" style="vertical-align:top">
                          <input type="text" id="first_12" name="q12_name12[first]" class="form-textbox" size="10" value="" data-component="first" aria-labelledby="label_12 sublabel_12_first" />
                          <label class="form-sub-label" for="first_12" id="sublabel_12_first" style="min-height:13px"> First Name </label>
                      </span>
                      <span class="form-sub-label-container" style="vertical-align:top">
                          <input type="text" id="last_12" name="q12_name12[last]" class="form-textbox" size="15" value="" data-component="last" aria-labelledby="label_12 sublabel_12_last" />
          ...
          <li class="form-line" data-type="control_phone" id="id_13">
              ...
              <div id="cid_15" class="form-input">
                  <div data-wrapper-react="true">
                      <span class="form-sub-label-container" style="vertical-align:top">
                          <input type="tel" id="input_13_area" name="q15_mobilePhone[area]" class="form-textbox" size="6" value="" data-component="areaCode" aria-labelledby="label_15 sublabel_15_area" />
                          <span class="phone-separate" aria-hidden="true">
                              -
                          </span>
                      ...
                      <span class="form-sub-label-container" style="vertical-align:top">
                          <input type="tel" id="input_13_phone" name="q13_homephone[phone]" class="form-textbox" size="12" value="" data-component="phone" aria-labelledby="label_15 sublabel_15_phone" />
          ...
          <li class="form-line" data-type="control_phone" id="id_14">
              ...
              <div id="cid_15" class="form-input">
                  <div data-wrapper-react="true">
                      <span class="form-sub-label-container" style="vertical-align:top">
                          <input type="tel" id="input_14_area" name="q15_homePhone[area]" class="form-textbox" size="6" value="" data-component="areaCode" aria-labelledby="label_15 sublabel_15_area" />
                          <span class="phone-separate" aria-hidden="true">
                              -
                          </span>
                      ...
                      <span class="form-sub-label-container" style="vertical-align:top">
                          <input type="tel" id="input_14_phone" name="q14_homephone[phone]" class="form-textbox" size="12" value="" data-component="phone" aria-labelledby="label_15 sublabel_15_phone" />
              ...
              <div id="cid_17" class="form-input-wide jf-required">
                  <div class="form-single-column" role="group" aria-labelledby="label_17" data-component="radio">
                      <span class="form-radio-item" style="clear:left">
                          ...
                          <input type="radio" class="form-radio validate[required]" id="input_17_0" name="q17_haveYou17" value="Yes" required="" />
                          <label id="label_input_17_0" for="input_17_0"> Yes </label>
                      </span>
                      <span class="form-radio-item" style="clear:left">
                          <span class="dragger-item">
                          </span>
                          <input type="radio" class="form-radio validate[required]" id="input_17_1" name="q17_haveYou17" value="No" required="" />
      ...
      <li class="form-line form-line-column form-col-1" data-type="control_radio" id="id_19">
        <label class="form-label form-label-left" id="label_19" for="input_19"> Chicken Pox (Varicella): </label>
        <div id="cid_19" class="form-input">
          <div class="form-single-column" role="group" aria-labelledby="label_19" data-component="radio">
            <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_19_0" name="q19_chickenPox19" value="IMMUNE" />
              <label id="label_input_19_0" for="input_19_0"> IMMUNE </label>
            </span>
            <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_19_1" name="q19_chickenPox19" value="NOT IMMUNE" />
        ...
        <div id="cid_20" class="form-input">
          <div class="form-single-column" role="group" aria-labelledby="label_20" data-component="radio">
            <span class="form-radio-item" style="clear:left">
              ...
              <input type="radio" class="form-radio" id="input_20_0" name="q20_measles" value="IMMUNE" />
              <label id="label_input_20_0" for="input_20_0"> IMMUNE </label>
            </span>
            <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_20_1" name="q20_measles" value="NOT IMMUNE" />
      ...
      <li class="form-line" data-type="control_textarea" id="id_21">
        ...
        <div id="cid_21" class="form-input-wide">
          <textarea id="input_21" class="form-textarea" name="q21_significantMedical" cols="40" rows="3" data-component="textarea" aria-labelledby="label_21"></textarea>
        </div>
      </li>
      ...
      <li class="form-line" data-type="control_textarea" id="id_23">
        ...
        <div id="cid_23" class="form-input-wide">
                ...
                <table id="input_health" style="width:100%">
                    <tr>
                        <th>Cholestrol</th>
                        <th><input id="HealthDate" type="date" value="" onload="getDate()" /></th>
                        <th>Details: <input id="HealthDetails" type="text"/></th>
                        <th>
                            Result:
                           <input type="radio" class="form-radio" id="input_19_0" name="result" value="+" />
                                <label id="label_input_19_0" for="input_19_0"> + </label>
                           <input type="radio" class="form-radio" id="input_19_1" name="result" value="-" />
          ...
          <li class="form-line" data-type="control_textarea" id="id_24">
              ...
              <div id="cid_24" class="form-input-wide">
                  <textarea id="input_24" class="form-textarea" name="q24_listAny24" cols="40" rows="3" data-component="textarea" aria-labelledby="label_24"></textarea>
              </div>
          </li>
          </li>
      ...
      <li class="form-line form-line-column form-col-1" data-type="control_textbox" id="id_35">
        ...
        <div id="cid_35" class="form-input">
          <input type="text" id="input_35" name="q35_height35" data-type="input-textbox" class="form-textbox validate[Numeric]" size="20" value="" placeholder=" " data-component="textbox" aria-labelledby="label_35" />
        </div>
      </li>
      <li class="form-line form-line-column form-col-2" data-type="control_textbox" id="id_36">
          ...
          <div id="cid_36" class="form-input">
              <input type="text" id="input_36" name="q36_weight" data-type="input-textbox" class="form-textbox validate[Numeric]" size="20" value="" placeholder=" " data-component="textbox" aria-labelledby="label_36" />
          </div>
          <li class="form-line" data-type="control_textarea" id="id_24">
              <label class="form-label form-label-top" id="label_24" for="input_24"> Other Health Issues: </label>
              <div id="cid_24" class="form-input-wide">
                  <textarea id="input_24" class="form-textarea" name="q24_listAny24" cols="40" rows="5" data-component="textarea" aria-labelledby="label_24"></textarea>
              </div>
          </li>
      </li>
